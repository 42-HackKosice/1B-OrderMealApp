                ...
                <div class="bg-white shadow-md rounded my-6">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th class="py-3 px-6 text-center">My order</th>
    ...
    <g id="_x35_3_59_">
        <path d="M409.934,70.334C364.579,24.979,304.274,0.001,240.133,0.001c-64.142,0-124.443,24.978-169.799,70.333
			...
			c-0.081,2.659-0.218,6.475-0.355,11.032C111.183,187.565,110.441,199.779,112.119,210.633z"/>
                                        ...
                                        {{--                                        {{dd($order)}}--}}
                                        <span  class="font-medium"> <a href="{{route('restaurants.show',$order->order->restaurant->id)}}">
                                        {{$order->order->restaurant->name}}  </a></span>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        {{$order->order->time->isoFormat('HH:mm dddd D ')}}
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-6 text-center">
                                    @if($order->order->time<\Carbon\Carbon::now())
